        ...
        <main className="p-6">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Admin Dashboard - Welcome, {user?.name || user?.display_name || 'Admin'}!
            </h1>
            <p className="text-gray-600">
              Overview of all student activities and system management.
            </p>
          </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm text-gray-600">Campaign completed successfully</p>
