          ...
          <Reveal key={s.n} delay={i * 0.07}>
            ...
            >
              ...
              <div className="bg-primary px-6 py-3 flex items-center justify-between">
                <span className="font-syne text-sm font-bold uppercase tracking-wide text-white">
                  {s.pill}
                </span>
                <span className="font-syne text-sm font-bold text-white/60">{s.n}</span>
              </div>
              <div className="p-7 bg-white/[0.03]">
                <p className="font-syne text-2xl md:text-3xl font-bold leading-[1.12] mb-3">
                  {s.problem}
                </p>
                <p className="text-sm text-white/40 leading-relaxed mb-6">{s.detail}</p>
                <div className="flex items-center gap-2 text-primary mb-3">
                  <ArrowDown size={14} />
                  <span className="text-[10px] uppercase tracking-[2px] font-medium">
                    {s.offering}
                  </span>
                </div>
